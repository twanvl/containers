...
module Data.Map.BaseIntInt (
            -- * Map type
              MapIntInt(..)          -- instance Eq,Show,Read
            , Key,Val
...
type Val = Int
data MapIntInt  = Tip
              | Bin {-# UNPACK #-} !Size {-# UNPACK #-} !Key {-# UNPACK #-} !Val !(MapIntInt) !(MapIntInt)

type Size     = Int

instance Monoid (MapIntInt) where
    mempty  = empty
    mappend = union
    mconcat = unions
...
lookup :: Key -> MapIntInt -> Maybe Val
lookup = go
  where
    STRICT_1_OF_2(go)
    go _ Tip = Nothing
...
lookupAssoc :: Key -> MapIntInt -> Maybe (Key,Val)
lookupAssoc = go
  where
    STRICT_1_OF_2(go)
    go _ Tip = Nothing
...
findWithDefault :: Val -> Key -> MapIntInt -> Val
...
insert :: Key -> Val -> MapIntInt -> MapIntInt
insert = go
  where
    STRICT_1_2_OF_3(go)
...
insertWith :: (Val -> Val -> Val) -> Key -> Val -> MapIntInt -> MapIntInt
...
insertWithKey :: (Key -> Val -> Val -> Val) -> Key -> Val -> MapIntInt -> MapIntInt
insertWithKey = go
  where
    STRICT_2_3_OF_4(go)
...
--
-- > let insertLookup kx x t = insertLookupWithKey (\_ a _ -> Val) kx x t
-- > insertLookup 5 "x" (fromList [(5,"a"), (3,"b")]) == (Just "a", fromList [(3, "b"), (5, "x")])
-- > insertLookup 7 "x" (fromList [(5,"a"), (3,"b")]) == (Nothing,  fromList [(3, "b"), (5, "a"), (7, "x")])

insertLookupWithKey :: (Key -> Val -> Val -> Val) -> Key -> Val -> MapIntInt
                    -> (Maybe Val, MapIntInt)
...
delete :: Key -> MapIntInt -> MapIntInt
delete = go
  where
    STRICT_1_OF_2(go)
    go _ Tip = Tip
...
adjust :: (Val -> Val) -> Key -> MapIntInt -> MapIntInt
...
adjustWithKey :: (Key -> Val -> Val) -> Key -> MapIntInt -> MapIntInt
...
update :: (Val -> Maybe Val) -> Key -> MapIntInt -> MapIntInt
...
updateWithKey :: (Key -> Val -> Maybe Val) -> Key -> MapIntInt -> MapIntInt
updateWithKey = go
  where
    STRICT_2_OF_3(go)
    go _ _ Tip = Tip
...
updateLookupWithKey :: (Key -> Val -> Maybe Val) -> Key -> MapIntInt -> (Maybe Val, MapIntInt)
...
alter :: (Maybe Val -> Maybe Val) -> Key -> MapIntInt -> MapIntInt
alter = go
  where
    STRICT_2_OF_3(go)
...
lookupIndex :: Key -> MapIntInt -> Maybe Int
...
updateAt :: (Key -> Val -> Maybe Val) -> Int -> MapIntInt -> MapIntInt
...
deleteAt :: Int -> MapIntInt -> MapIntInt
deleteAt i m
...
updateMin :: (Val -> Maybe Val) -> MapIntInt -> MapIntInt
updateMin f m
...
updateMax :: (Val -> Maybe Val) -> MapIntInt -> MapIntInt
updateMax f m
...
updateMinWithKey :: (Key -> Val -> Maybe Val) -> MapIntInt -> MapIntInt
...
updateMaxWithKey :: (Key -> Val -> Maybe Val) -> MapIntInt -> MapIntInt
...
minViewWithKey :: MapIntInt -> Maybe ((Key,Val), MapIntInt)
...
maxViewWithKey :: MapIntInt -> Maybe ((Key,Val), MapIntInt)
...
minView :: MapIntInt -> Maybe (Val, MapIntInt)
minView Tip = Nothing
...
maxView :: MapIntInt -> Maybe (Val, MapIntInt)
maxView Tip = Nothing
...
unionsWith :: (Val -> Val -> Val) -> [MapIntInt] -> MapIntInt
unionsWith f ts
...
union :: MapIntInt -> MapIntInt -> MapIntInt
union Tip t2  = t2
union t1 Tip  = t1
...
hedgeUnionL :: MaybeS Key -> MaybeS Key -> MapIntInt -> MapIntInt
            -> MapIntInt
...
unionWith :: (Val -> Val -> Val) -> MapIntInt -> MapIntInt -> MapIntInt
unionWith f m1 m2
...
unionWithKey :: (Key -> Val -> Val -> Val) -> MapIntInt -> MapIntInt -> MapIntInt
...
hedgeUnionWithKey :: (Key -> Val -> Val -> Val)
                  -> MaybeS Key -> MaybeS Key
                  -> MapIntInt -> MapIntInt
                  -> MapIntInt
...
difference :: MapIntInt -> MapIntInt -> MapIntInt
...
hedgeDiff :: MaybeS Key -> MaybeS Key -> MapIntInt -> MapIntInt -> MapIntInt
hedgeDiff _     _     Tip _
  = Tip
...
differenceWith :: (Val -> Val -> Maybe Val) -> MapIntInt -> MapIntInt -> MapIntInt
...
differenceWithKey :: (Key -> Val -> Val -> Maybe Val) -> MapIntInt -> MapIntInt -> MapIntInt
...
hedgeDiffWithKey :: (Key -> Val -> Val -> Maybe Val)
                 -> MaybeS Key -> MaybeS Key
                 -> MapIntInt -> MapIntInt
                 -> MapIntInt
...
intersection :: MapIntInt -> MapIntInt -> MapIntInt
intersection m1 m2
...
intersectionWith :: (Val -> Val -> Val) -> MapIntInt -> MapIntInt -> MapIntInt
...
intersectionWithKey :: (Key -> Val -> Val -> Val) -> MapIntInt -> MapIntInt -> MapIntInt
...
--
isSubmapOf :: MapIntInt -> MapIntInt -> Bool
...
-}
isSubmapOfBy :: (Val -> Val -> Bool) -> MapIntInt -> MapIntInt -> Bool
...
submap' :: (Val -> Val -> Bool) -> MapIntInt -> MapIntInt -> Bool
submap' _ Tip _ = True
...
isProperSubmapOf :: MapIntInt -> MapIntInt -> Bool
...
-}
isProperSubmapOfBy :: (Val -> Val -> Bool) -> MapIntInt -> MapIntInt -> Bool
...
filter :: (Val -> Bool) -> MapIntInt -> MapIntInt
filter p m
...
filterWithKey :: (Key -> Val -> Bool) -> MapIntInt -> MapIntInt
...
partition :: (Val -> Bool) -> MapIntInt -> (MapIntInt,MapIntInt)
partition p m
...
partitionWithKey :: (Key -> Val -> Bool) -> MapIntInt -> (MapIntInt,MapIntInt)
...
mapMaybe :: (Val -> Maybe Val) -> MapIntInt -> MapIntInt
...
mapMaybeWithKey :: (Key -> Val -> Maybe Val) -> MapIntInt -> MapIntInt
...
mapEither :: (Val -> Either Val Val) -> MapIntInt -> (MapIntInt, MapIntInt)
mapEither f m
...
mapEitherWithKey :: (Key -> Val -> Either Val Val) -> MapIntInt -> (MapIntInt, MapIntInt)
...
map :: (Val -> Val) -> MapIntInt -> MapIntInt
...
mapWithKey :: (Key -> Val -> Val) -> MapIntInt -> MapIntInt
...
mapAccum :: (b -> Val -> (b,Val)) -> b -> MapIntInt -> (b,MapIntInt)
mapAccum f a m
...
mapAccumWithKey :: (b -> Key -> Val -> (b,Val)) -> b -> MapIntInt -> (b,MapIntInt)
mapAccumWithKey f a t
  = mapAccumL f a t

-- | /O(n)/. The function 'mapAccumL' threads an accumulating
-- argument through the map in ascending order of keys.
mapAccumL :: (b -> Key -> Val -> (b,Val)) -> b -> MapIntInt -> (b,MapIntInt)
...
mapAccumRWithKey :: (b -> Key -> Val -> (b,Val)) -> b -> MapIntInt -> (b,MapIntInt)
...
mapKeys :: (Key -> Key) -> MapIntInt -> MapIntInt
...
mapKeysWith :: (Val -> Val -> Val) -> (Key -> Key) -> MapIntInt -> MapIntInt
...
mapKeysMonotonic :: (Key -> Key) -> MapIntInt -> MapIntInt
...
foldrWithKey :: (Key -> Val -> b -> b) -> b -> MapIntInt -> b
foldrWithKey f = go
  where
    go z Tip             = z
...
foldlWithKey :: (b -> Key -> Val -> b) -> b -> MapIntInt -> b
foldlWithKey f = go
  where
    go z Tip              = z
...
fromListWith :: (Val -> Val -> Val) -> [(Key,Val)] -> MapIntInt
fromListWith f xs
...
fromListWithKey :: (Key -> Val -> Val -> Val) -> [(Key,Val)] -> MapIntInt
...
toAscList :: MapIntInt -> [(Key,Val)]
toAscList = foldrWithKey (\k x xs -> (k,x):xs) []

-- | /O(n)/. Convert the map to a list of key\/value pairs where the keys
-- are in descending order. Subject to list fusion.
toDescList :: MapIntInt -> [(Key,Val)]
...
fromAscListWith :: (Val -> Val -> Val) -> [(Key,Val)] -> MapIntInt
...
fromAscListWithKey :: (Key -> Val -> Val -> Val) -> [(Key,Val)] -> MapIntInt
...
fromDistinctAscList :: [(Key,Val)] -> MapIntInt
...
--------------------------------------------------------------------}
trim :: MaybeS Key -> MaybeS Key -> MapIntInt -> MapIntInt
...
trimLookupLo :: Key -> MaybeS Key -> MapIntInt -> (Maybe (Key,Val), MapIntInt)
...
--------------------------------------------------------------------}
filterGt :: MaybeS Key -> MapIntInt -> MapIntInt
...
filterLt :: MaybeS Key -> MapIntInt -> MapIntInt
...
split :: Key -> MapIntInt -> (MapIntInt,MapIntInt)
split k t = k `seq`
  case t of
    Tip            -> (Tip, Tip)
...
splitLookup :: Key -> MapIntInt -> (MapIntInt,Maybe Val,MapIntInt)
...
-- | /O(log n)/.
splitLookupWithKey :: Key -> MapIntInt -> (MapIntInt,Maybe (Key,Val),MapIntInt)
...
{--------------------------------------------------------------------
  Join
--------------------------------------------------------------------}
join :: Key -> Val -> MapIntInt -> MapIntInt -> MapIntInt
...
insertMax,insertMin :: Key -> Val -> MapIntInt -> MapIntInt
insertMax kx x t
  = case t of
      Tip -> singleton kx x
      Bin _ ky y l r
...
--------------------------------------------------------------------}
merge :: MapIntInt -> MapIntInt -> MapIntInt
merge Tip r   = r
merge l Tip   = l
...
--------------------------------------------------------------------}
glue :: MapIntInt -> MapIntInt -> MapIntInt
glue Tip r = r
glue l Tip = l
glue l r
...
deleteFindMin :: MapIntInt -> ((Key,Val),MapIntInt)
deleteFindMin t
  = case t of
...
deleteFindMax :: MapIntInt -> ((Key,Val),MapIntInt)
deleteFindMax t
  = case t of
...
--
--   balance :: Key -> Val -> MapIntInt -> MapIntInt -> MapIntInt
--   balance k x l r
...
balanceL :: Key -> Val -> MapIntInt -> MapIntInt -> MapIntInt
...
balanceR :: Key -> Val -> MapIntInt -> MapIntInt -> MapIntInt
...
--------------------------------------------------------------------}
bin :: Key -> Val -> MapIntInt -> MapIntInt -> MapIntInt
bin k x l r
...
instance NFData (MapIntInt) where
    rnf Tip = ()
...
{--------------------------------------------------------------------
  Show
--------------------------------------------------------------------}
instance Show (MapIntInt) where
  showsPrec d m  = showParen (d > 10) $
    showString "fromList " . shows (toList m)

-- | /O(n)/. Show the tree that implements the map. The tree is shown
-- in a compressed, hanging format. See 'showTreeWith'.
showTree :: MapIntInt -> String
showTree m
...
-}
showTreeWith :: (Key -> Val -> String) -> Bool -> Bool -> MapIntInt -> String
showTreeWith showelem hang wide t
  | hang      = (showsTreeHang showelem wide [] t) ""
  | otherwise = (showsTree showelem wide [] [] t) ""

showsTree :: (Key -> Val -> String) -> Bool -> [String] -> [String] -> MapIntInt -> ShowS
...
showsTreeHang :: (Key -> Val -> String) -> Bool -> [String] -> MapIntInt -> ShowS
...
#include "Typeable.h"
INSTANCE_TYPEABLE0(MapIntInt,mapIntIntTc,"MapIntInt")
...
valid :: MapIntInt -> Bool
valid t
  = balanced t && ordered t && validsize t

ordered :: MapIntInt -> Bool
ordered t
